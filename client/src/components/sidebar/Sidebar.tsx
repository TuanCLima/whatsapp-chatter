      ...
      <div className="px-2 py-2 border-b border-border">
        <div className="flex space-x-1 bg-secondary rounded-md p-0.5">
          ...
          <button 
            ...
            className={`flex-1 py-1.5 text-xs font-medium rounded-sm ${
              activeTab === 'unread' ? 'bg-background text-foreground' : 'text-muted-foreground hover:text-foreground'
            }`}
          >
            Não lidas
          </button>
          <button 
            ...
            className={`flex-1 py-1.5 text-xs font-medium rounded-sm ${
              activeTab === 'favorites' ? 'bg-background text-foreground' : 'text-muted-foreground hover:text-foreground'
            }`}
          >
            Favoritas
          </button>
          <button 
            ...
            className={`flex-1 py-1.5 text-xs font-medium rounded-sm ${
              activeTab === 'groups' ? 'bg-background text-foreground' : 'text-muted-foreground hover:text-foreground'
            }`}
          >
            Grupos
          </button>
