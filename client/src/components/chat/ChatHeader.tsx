...
export default function ChatHeader({ contact, setMobileMenuOpen, onToggleConversation }: ChatHeaderProps) {
    ...
    <div className="p-3 bg-card border-b border-border flex items-center justify-between">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex items-center space-x-2">
          <Label htmlFor="conversation-toggle" className="text-xs text-muted-foreground">
            Chat AI
          </Label>
          <Switch
